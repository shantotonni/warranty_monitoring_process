        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Area Create</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('areas.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('NameBn') ? 'has-error' : '' }}">
                                    ...
                                    <input name="NameBn" type="text" id="NameBn" class="form-control" value="{{ old('NameBn') }}" required autofocus placeholder="Enter Name in Bangla">
