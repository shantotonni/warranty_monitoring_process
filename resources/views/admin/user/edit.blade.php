    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('users.update', $user->Id) }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('Name') ? 'has-error' : '' }}">
                                    ...
                                    <input name="Name" type="text" id="Name" class="form-control" value="{{ $user->Name }}" required autofocus placeholder="Enter Name">
                                    @if ($errors->has('Name'))
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('UserId') ? 'has-error' : '' }}">
                                    ...
                                    <input name="UserId" type="text" id="UserId" class="form-control" value="{{ $user->UserId }}" required autofocus placeholder="Enter UserId">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('Password') ? 'has-error' : '' }}">
                                    ...
                                    <input name="Password" type="text" id="Password" class="form-control" value="" autofocus placeholder="Enter Password">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('RoleId') ? 'has-error' : '' }}">
                                    ...
                                    <select name="RoleId" id="role_Id" onchange="roleChange()" data-live-search="true" class="form-control select2" style="width: 100%;" autofocus type="select" required>
                                        ...
                                        <option value="{{$role->Id}}" @if($role->Id == $user->RoleId){{"selected"}} @endif">{{$role->Name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6" id="spo_region" style="display: none;">
                                <div class="form-group{{ $errors->has('RegionId') ? 'has-error' : '' }}">
                                    ...
                                    <select name="RegionId" id="RegionId" data-live-search="true" class="form-control select2" style="width: 100%;" type="select">
                                        ...
                                        <option value="{{$region->Id}}" @if($region->Id == $user->RegionId){{"selected"}} @endif">{{$region->Name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('Designation') ? 'has-error' : '' }}">
                                    ...
                                    <input name="Designation" type="text" id="Designation" class="form-control" value="{{ $user->Designation }}" required autofocus placeholder="Enter Designation">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('Mobile') ? 'has-error' : '' }}">
                                    ...
                                    <input name="Mobile" type="number" id="Mobile" class="form-control" value="{{ $user->Mobile }}" required autofocus placeholder="Enter Mobile Number">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('Email') ? 'has-error' : '' }}">
                                    ...
                                    <input name="Email" type="email" id="Email" class="form-control" value="{{ $user->Email }}" required autofocus placeholder="Enter Email Address">
                                    @if ($errors->has('Email'))
                            ...
                            <div class="col-sm-6" style="display: none;" id="signature_show">
                                <div class="form-group {{ $errors->has('SignatureImage') ? 'has-error' : '' }}">
                                    ...
                                    <input name="SignatureImage" type="file" id="SignatureImage" class="form-control" value="{{ $user->SignatureImage }}">
...
<script>
    if ($('#role_Id :selected').val() == 1) {
        $('#spo_region').show();
    }

    if ($('#role_Id :selected').val() == 3) {
        $('#signature_show').show();
    }
