        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Warranty Claim Info (SPO) Edit</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<!-- Main content -->
<div class="container-fluid">
    <form role="form" class="repeater" enctype="multipart/form-data" method="POST" action="{{ route('claim-warranty.update', $warranty->Id) }}">
        {{ csrf_field() }}
        {{ method_field("PUT") }}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edit Warranty Claim Info (SPO)</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('Purpose') ? 'has-error' : '' }}">
                                    ...
                                    <select name="Purpose" id="Purpose" data-live-search="true" class="form-control select2" style="width: 100%;" autofocus type="select" required>
                                        ...
                                        <option value="Warranty" @if($warranty->Purpose == "Warranty"){{"selected"}} @endif">For Warranty</option>
                                        <option value="Goodwill" @if($warranty->Purpose == "Goodwill"){{"selected"}} @endif">For Goodwill</option>
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('ProductId') ? 'has-error' : '' }}">
                                    ...
                                    <select name="ProductId" id="ProductId" data-live-search="true" class="form-control select2" style="width: 100%;" autofocus type="select" required>
                                        ...
                                        <option value="{{ $product->Id }}" @if ($product->Id == $warranty->ProductId) {{ 'selected' }} @endif">
                                            {{ $product->Name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('EngineerId') ? 'has-error' : '' }}">
                                    ...
                                    <select name="EngineerId" id="EngineerId" data-live-search="true" class="form-control select2" style="width: 100%;" autofocus type="select" required>
                                        ...
                                        <option value="{{ $engineer->UserId }}" @if ($engineer->UserId == $warranty->EngineerId) {{ 'selected' }} @endif">
                            ...
                            <div data-repeater-item class="row">
                                <div class="col-lg-6">
                                    <div class="form-group{{ $errors->has('PartsCode') ? 'has-error' : '' }}">
                                        ...
                                        <select name="PartsCode" data-live-search="true" onchange="selectedParts(this.value, this)" class="form-control parts-code select2" style="width: 100%;" autofocus type="select" required>
                                            ...
                                            <option value="{{ $part['PartsCode'] }}"  @if($part['PartsCode']==$detail['PartsNumber']) {{"selected"}}  @endif >{{ $part['PartsCode'] }} -
                                                {{ $part['PartsName'] }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group {{ $errors->has('Quantity') ? 'has-error' : '' }}">
                                        ...
                                        <input name="Quantity" type="text" class="form-control" value="{{ $detail->Quantity }}" required autofocus placeholder="Enter Quantity">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group {{ $errors->has('Price') ? 'has-error' : '' }}">
                                        ...
                                        @foreach($allParts as $part)  
                                            @if($part['PartsCode']==$detail['PartsNumber']) 
                                                <input name="Price" type="text" class="form-control price" value="{{$part->Price}}" required autofocus placeholder="Enter Price">
                                            @endif 
                                        @endforeach
                                        @if ($errors->has('Price'))
...
<script>
    ...
    function selectedParts(selectedParts, obj) {
        //.log("You have selected the Parts - " + selectedParts);
        $.ajax({
