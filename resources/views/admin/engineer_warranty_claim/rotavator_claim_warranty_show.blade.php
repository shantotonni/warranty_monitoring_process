        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Warranty Claim Info [Rotavator] Show</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            ...
            <div class="card" style="font-size: 18px;">
                <div class="card-header">
                    <h4 class="card-title">Warranty Claim Info - Rotavator</h4>
                ...
                <div class="card-body" id="print" style="font-size: 20px;">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <h5 class="text-center">WARRANTY CLAIM FORM (Rotavator)</h5>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <table class="table table-bordered table-sm small">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>@if($warranty->product->Id==4) HAR/WRT/{{ $warranty->Id }} @endif</td>
                                    </tr>
                                    <tr>
                                        <th>Product</th>
                        ...
                        <div class="col-sm-12">
                            <table class="table table-bordered table-sm small">
                                <tbody>
                                    ...
                                    <tr>
                                        <th style="width: 200px;">SE Observation</th>
                            ...
                            <table class="table table-bordered table-sm small">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ date_format(date_create($warranty->FailureDate), 'd-M-Y') }}</td>
                                    </tr>
                                    <tr>
                                        <th>Repair Done Date</th>
                                        <td>{{ date_format(date_create($warranty->RepairDate), 'd-M-Y') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-sm-6">
                            <table class="table table-bordered table-sm small">
                                <tbody>
                                    <tr>
                                        <th>Failure Area</th>
                                        <td>{{ $warranty->FailureArea }}</td>
                                    </tr>
                                    <tr>
                                        <th>Warranty Claim Date</th>
                                        <td>{{ date_format(date_create($warranty->WarrantyClaimDate), 'd-M-Y') }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
