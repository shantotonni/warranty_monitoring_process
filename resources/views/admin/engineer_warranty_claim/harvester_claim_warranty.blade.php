...
<div class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Warranty Claim Form ( Harvester )</li>
        </ol>
        </div><!-- /.col -->
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
           ...
           <div class="row">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h4 class="card-title">Warranty Claim Form ( Harvester )</h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                        {{ csrf_field() }}
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('MQRNumber') ? 'has-error' : '' }}">
                                    <label for="MQRNumber">MQR Number</label>
                                    <input name="MQRNumber" type="text" id="MQRNumber" class="form-control" value="{{ $warranty->MQRNumber }}" required autofocus placeholder="Enter MQR Number">
                                        @if ($errors->has('MQRNumber'))
                                            <span class="help-block"><strong>{{ $errors->first('MQRNumber') }}</strong></span>
                                        @endif
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('JobCardNo') ? 'has-error' : '' }}">
                                    <label for="JobCardNo">Job Card No</label>
                                    <input name="JobCardNo" type="text" id="JobCardNo" class="form-control" value="{{ $warranty->JobCardNo }}" required autofocus placeholder="Enter Job Card No">
                                        @if ($errors->has('JobCardNo'))
                                            <span class="help-block"><strong>{{ $errors->first('JobCardNo') }}</strong></span>
                                        @endif
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('MQRDate') ? 'has-error' : '' }}">
                                    <label for="MQRDate">MQR Date</label>
                                    <input name="MQRDate" autocomplete="off" type="text" id="datepicker2" class="form-control" value="{{ $warranty->MQRDate }}" required autofocus placeholder="Enter MQR Date">
                                        @if ($errors->has('MQRDate'))
                                            <span class="help-block"><strong>{{ $errors->first('MQRDate') }}</strong></span>
                                        @endif
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group {{ $errors->has('JobCardDate') ? 'has-error' : '' }}">
                                    <label for="JobCardDate">Job Card Date</label>
                                    <input name="JobCardDate" autocomplete="off" type="text" id="datepicker3" class="form-control" value="{{ $warranty->JobCardDate }}" required autofocus placeholder="Enter Job Card Date">
                                        @if ($errors->has('JobCardDate'))
                                            <span class="help-block"><strong>{{ $errors->first('JobCardDate') }}</strong></span>
                                        @endif
                                </div>
                            </div>
                        </div>
