        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">User Area Create</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h4 class="card-title">Map Engineer Area</h4>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form class="" role="form" method="POST" action="{{ route('user-areas.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group{{ $errors->has('AreaId') ? 'has-error' : '' }}">
                                    ...
                                    <select name="AreaId" id="AreaId" data-live-search="true" class="form-control select2" style="width: 100%;" type="select" required>
